...
/init_scripts/install_s6init.sh
...
# set up default user
/init_scripts/default_user.sh "${DEFAULT_USER}"

# install user config initiation script
cp /init_scripts/init_set_env.sh /etc/cont-init.d/01_set_env
cp /init_scripts/init_userconf.sh /etc/cont-init.d/02_userconf
cp /init_scripts/pam-helper.sh /usr/lib/rstudio-server/bin/pam-helper
